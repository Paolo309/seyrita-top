...
#(
  ...
  // |   TCDM INTF   |
  // ----------------
  localparam int unsigned TcdmSize = 96;
  ...
  function automatic snitch_pma_pkg::rule_t [snitch_pma_pkg::NrMaxRules-1:0] get_cached_regions();
    ...
    // cached_regions[2] = '{base: SnitchBootROMRegionStart, mask: 48'hffff_fff8_0000}; // Boot ROM ( 512 KiB)
  ...
  snitch_cluster #(
    ...
    .NrBanks          (48),
    .NrHyperBanks     (2),
    // GALFANOP: TCDM size = 48 * 256 * 64 bit = 96 KiB
  ...
  axi_cut #(
    .Bypass    (0),
    .aw_chan_t (cluster_narrow_out_dw_conv_aw_chan_t),
    .w_chan_t  (cluster_narrow_out_dw_conv_w_chan_t),
    .b_chan_t  (cluster_narrow_out_dw_conv_b_chan_t),
    .ar_chan_t (cluster_narrow_out_dw_conv_ar_chan_t),
