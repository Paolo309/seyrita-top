...
#################################
CHIM_HW_INIT = chs-hw-init snitch-hw-init chim-bootrom-init
CHIM_HW_ALL = $(CHIM_HW_INIT) chs-sim-all
CHIM_SW_ALL = chim-sw
CHIM_ALL += $(CHIM_HW_ALL) $(CHIM_SW_ALL) chim-sim
CHIM_CLEAN += chim-sw-clean chim-sim-clean

.PHONY: chim-hw-init
chim-hw-init: $(CHIM_HW_INIT) ## Initialize chimera hardware (no sim)
